...
// we require this package (“fs”)to read a text file of any format. 
var fs= require("fs")
// create a express object for web application 
var app=express()
// add middle ware function for body parsing 
var bodyParser = require("body-parser"); 
app.use(bodyParser.urlencoded({ extended: true }));
// use getmethod to create a service function in REST API
app.get('/',function(req,res){
    // use response object to write the text on the browser
...
function (req, res) {
     ...
     res.send({ 
        status: true, message: 'form Details', data: {
        name: name,
        age:Age,
        Qualification:Qual, 
        }
